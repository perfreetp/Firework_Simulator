...
(function initFireworksAppConfig(global) {
	const config = {
		...
		selectors: Object.freeze({
			...
			showEditorClose: ".show-editor__close",
			...
			showStatus: ".show-editor__status",
			showProgramList: ".show-program-list",
			showTimelineTrack: ".show-timeline__track",
			showTimelineTotal: ".show-timeline__total",
			showPlayer: ".show-player",
			showPlayerName: ".show-player__name",
			showPlayerCurrent: ".show-player__current",
			showPlayerProgressBar: ".show-player__progress-bar",
			showPlayerElapsed: ".show-player__elapsed",
			showPlayerTotal: ".show-player__total",
			showPlayerPauseBtn: ".show-player__pause",
			showPlayerPauseIcon: ".show-player__pause use",
			showPlayerSkipBtn: ".show-player__skip",
			showPlayerStopBtn: ".show-player__stop",
			wishPanel: ".wish-panel",
			wishPanelClose: ".wish-panel__close",
			wishInput: ".wish-input",
			wishSubmitBtn: ".wish-submit-btn",
			wishClearBtn: ".wish-clear-btn",
			wishList: ".wish-panel__list",
		}),
